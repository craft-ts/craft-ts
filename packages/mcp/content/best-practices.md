# Craft NG best practices for coding agents

This guide is the contract for generating `@craft-ng/core` code in an application that already imported the library. Prefer it over Angular class/signal habits.

Public docs: https://ng-angular-stack.github.io/craft
LLM index: https://ng-angular-stack.github.io/craft/llms.txt
Full dump: https://ng-angular-stack.github.io/craft/llms-full.txt
