...
- Enhance craft-service with provided input handling and branded service providers ([e3507f898](https://github.com/craft-ts/craft-ts/commit/e3507f898))
- add demo component for sending context to AI ([296c10eb5](https://github.com/craft-ts/craft-ts/commit/296c10eb5))
- add track functionality for dependency management in craftService ([56009ea07](https://github.com/craft-ts/craft-ts/commit/56009ea07))
- enhance route and service handling with typed providers and yield support ([c36489c38](https://github.com/craft-ts/craft-ts/commit/c36489c38))
- add route providers documentation and enhance abstract service functionality ([8c3a4dbcd](https://github.com/craft-ts/craft-ts/commit/8c3a4dbcd))
- implement generator-based redirectTo for type-safe dependency tracking in routes ([8223b4e27](https://github.com/craft-ts/craft-ts/commit/8223b4e27))
- introduce craftGen for reusable generator factories and enhance routing guards ([45e8f398f](https://github.com/craft-ts/craft-ts/commit/45e8f398f))
- enhance routing guards to support observables and async results ([6b2a77093](https://github.com/craft-ts/craft-ts/commit/6b2a77093))
- update version to 0.5.1-beta.0 in package.json ([5b2cace79](https://github.com/craft-ts/craft-ts/commit/5b2cace79))
- add per-file DI checks and ESLint workflow documentation ([f097662a7](https://github.com/craft-ts/craft-ts/commit/f097662a7))
- add yieldable template contracts ([da8ebf169](https://github.com/craft-ts/craft-ts/commit/da8ebf169))
- add fine-grained component reactivity ([31c1a78a6](https://github.com/craft-ts/craft-ts/commit/31c1a78a6))
- render Craft nodes through a native DOM adapter ([316c73908](https://github.com/craft-ts/craft-ts/commit/316c73908))
- run craftHttpClient on fetch ([97cc30f69](https://github.com/craft-ts/craft-ts/commit/97cc30f69))
- run craft reactivity on alien-signals ([77d2023cf](https://github.com/craft-ts/craft-ts/commit/77d2023cf))
- replace Angular EnvironmentInjector with CraftInjector ([57ababc6c](https://github.com/craft-ts/craft-ts/commit/57ababc6c))
- replace Angular Router with a Craft history matcher ([de4b1b854](https://github.com/craft-ts/craft-ts/commit/de4b1b854))
- list reloading page clients so agents can see ghosts ([c18641310](https://github.com/craft-ts/craft-ts/commit/c18641310))
- drop Angular peers from core and ship @craft-ng/angular ([e508a56ab](https://github.com/craft-ts/craft-ts/commit/e508a56ab))
- delete the Angular island and run the core suite without Angular ([2820439c1](https://github.com/craft-ts/craft-ts/commit/2820439c1))
- boot, build and serve the demo without Angular ([de1808c8d](https://github.com/craft-ts/craft-ts/commit/de1808c8d))
- add Effect server function architecture demo ([ef34067eb](https://github.com/craft-ts/craft-ts/commit/ef34067eb))
- enforce Effect v4 diagnostics ([d4147d7d9](https://github.com/craft-ts/craft-ts/commit/d4147d7d9))
- detect server functions defined outside *.fn-serveur.ts files ([454e6ef0d](https://github.com/craft-ts/craft-ts/commit/454e6ef0d))
- add SSR and hydration runtime ([803b66a05](https://github.com/craft-ts/craft-ts/commit/803b66a05))
- pass npm OTP during release ([10b7c4c6f](https://github.com/craft-ts/craft-ts/commit/10b7c4c6f))
- make craftMiddleware yieldable ([59c24215d](https://github.com/craft-ts/craft-ts/commit/59c24215d))
- seal level 2 and record the matrix of the design system ([e80bcffc3](https://github.com/craft-ts/craft-ts/commit/e80bcffc3))
- context obligations that stop the build — wave 3, tasks 23 to 26 ([721d90c0e](https://github.com/craft-ts/craft-ts/commit/721d90c0e))
- style queries from the CLI and from MCP — wave 4, task 29 ([9d98b4963](https://github.com/craft-ts/craft-ts/commit/9d98b4963))
- **component:** merge component host properties ([099883b95](https://github.com/craft-ts/craft-ts/commit/099883b95))
- **component:** infer Angular directive inputs from node props ([50546af64](https://github.com/craft-ts/craft-ts/commit/50546af64))
- **component:** support configured Angular directive pipes ([e1076eb9b](https://github.com/craft-ts/craft-ts/commit/e1076eb9b))
- **component:** add scoped style registry and customization docs ([55f64325e](https://github.com/craft-ts/craft-ts/commit/55f64325e))
- **component:** CSS variables contract for craft components ([dc6d2e8ab](https://github.com/craft-ts/craft-ts/commit/dc6d2e8ab))
- **component:** settledValue + pendingBlock, type-safe suspension ([15a77abae](https://github.com/craft-ts/craft-ts/commit/15a77abae))
- **component:** pendingBlock reloading slot, and reliable boundary recovery ([7dbf7675f](https://github.com/craft-ts/craft-ts/commit/7dbf7675f))
- **component:** add fieldControl a11y prop bundles ([0b24c0210](https://github.com/craft-ts/craft-ts/commit/0b24c0210))
- **component:** add disclosureControl ARIA linking ([c775e3394](https://github.com/craft-ts/craft-ts/commit/c775e3394))
- **component:** add buttonControl with opt-in keepFocusable ([27f80e66b](https://github.com/craft-ts/craft-ts/commit/27f80e66b))
- **component:** keep liveRegion mounted as an optional landmark ([db7403eaf](https://github.com/craft-ts/craft-ts/commit/db7403eaf))
- **component:** add getByRole and getByLabel template queries ([d0aacf433](https://github.com/craft-ts/craft-ts/commit/d0aacf433))
- **component:** add clickFocus for gesture-sync focusing ([410cf0067](https://github.com/craft-ts/craft-ts/commit/410cf0067))
- **component:** propagate contract channels through every node ([b489b88b5](https://github.com/craft-ts/craft-ts/commit/b489b88b5))
- **component:** add scheduled each rendering ([2d7833b5c](https://github.com/craft-ts/craft-ts/commit/2d7833b5c))
- **core:** infrastructure CraftPrimitiveGen + craftUse ([03e2fc658](https://github.com/craft-ts/craft-ts/commit/03e2fc658))
- ⚠️  **core:** state/query/mutation/asyncProcess/queryParam retournent un générateur ([847ae73c5](https://github.com/craft-ts/craft-ts/commit/847ae73c5))
- ⚠️  **core:** suppression de track() ([f8780ce67](https://github.com/craft-ts/craft-ts/commit/f8780ce67))
- **core:** re-run loader on every imperative method call ([d72118d90](https://github.com/craft-ts/craft-ts/commit/d72118d90))
- **core:** add craftLazy for lazy service imports; rename untilSettled → craftUntilSettled ([c23c61696](https://github.com/craft-ts/craft-ts/commit/c23c61696))
- **core:** add craftMatch for exhaustive literal-union pattern matching ([1b2197c5e](https://github.com/craft-ts/craft-ts/commit/1b2197c5e))
- **core:** add Craft runtime registry ([02181eac5](https://github.com/craft-ts/craft-ts/commit/02181eac5))
- **core:** add Standard Schema validation primitives ([dfe47a4d2](https://github.com/craft-ts/craft-ts/commit/dfe47a4d2))
- **core:** add typed insertion pipes ([79d0ec936](https://github.com/craft-ts/craft-ts/commit/79d0ec936))
- **core:** sync document lang and dir through BrowserDocument ([b65847b5f](https://github.com/craft-ts/craft-ts/commit/b65847b5f))
- **core:** carry opaque contract channels through the vnode ([1460885ce](https://github.com/craft-ts/craft-ts/commit/1460885ce))
- **core:** craftStateMachine ([d6b5a6f51](https://github.com/craft-ts/craft-ts/commit/d6b5a6f51))
- **core:** accept bare transitions without transitionSetup ([04410fcd7](https://github.com/craft-ts/craft-ts/commit/04410fcd7))
- **core:** addressable primitive registry ([cc4cab6f0](https://github.com/craft-ts/craft-ts/commit/cc4cab6f0))
- **core:** machine history and back navigation ([da6c755c9](https://github.com/craft-ts/craft-ts/commit/da6c755c9))
- **core:** persist a machine history across a reload ([58ade6b3d](https://github.com/craft-ts/craft-ts/commit/58ade6b3d))
- **core:** mark replay writes, and stop poisoning unsettled resources ([2ec0e6046](https://github.com/craft-ts/craft-ts/commit/2ec0e6046))
- **core:** freeze a resource's params while its value is being restored ([fdaf15f7a](https://github.com/craft-ts/craft-ts/commit/fdaf15f7a))
- **core:** restore a resource without detaching it from its loader ([6f326bc95](https://github.com/craft-ts/craft-ts/commit/6f326bc95))
- **core:** tell apart hosts that can exist several times ([cace84347](https://github.com/craft-ts/craft-ts/commit/cace84347))
- **core:** do not record a moment identical to the current one ([4b37a5fd2](https://github.com/craft-ts/craft-ts/commit/4b37a5fd2))
- **demo:** add the yield* Effect example, with a live pump trace ([347aa2df9](https://github.com/craft-ts/craft-ts/commit/347aa2df9))
- **demo:** profile editor state machine example ([273333c9b](https://github.com/craft-ts/craft-ts/commit/273333c9b))
- **demo:** history and back navigation on the profile editor ([84e3af6d3](https://github.com/craft-ts/craft-ts/commit/84e3af6d3))
- **demo:** one state machine per row ([94f743ede](https://github.com/craft-ts/craft-ts/commit/94f743ede))
- **demo:** a mini design system built on @craft-ts/style ([a649c2055](https://github.com/craft-ts/craft-ts/commit/a649c2055))
- **demo-effect:** route the sync/async members example and unblock syncEffect ([8f1349442](https://github.com/craft-ts/craft-ts/commit/8f1349442))
- **dev-tools:** codemod migrate-primitive-generators ([25c08b7a1](https://github.com/craft-ts/craft-ts/commit/25c08b7a1))
- **dev-tools:** règle require-primitive-generator-unwrap + maj des codemods ([3655a7e44](https://github.com/craft-ts/craft-ts/commit/3655a7e44))
- **dev-tools:** add template migration tooling ([5e2ae2ebd](https://github.com/craft-ts/craft-ts/commit/5e2ae2ebd))
- **dev-tools:** enforce Craft HTTP transports ([a75157c47](https://github.com/craft-ts/craft-ts/commit/a75157c47))
- **dev-tools:** forbid Angular input output APIs ([4a37fd954](https://github.com/craft-ts/craft-ts/commit/4a37fd954))
- **dev-tools:** enforce yielded resource triggers ([2c240a813](https://github.com/craft-ts/craft-ts/commit/2c240a813))
- **dev-tools:** prevent colocated craft services and components ([f6ee5d329](https://github.com/craft-ts/craft-ts/commit/f6ee5d329))
- **dev-tools:** extend architecture graph backends ([cd59da6e5](https://github.com/craft-ts/craft-ts/commit/cd59da6e5))
- **dev-tools:** make craftStateMachine a host in the dependency graph ([8f62caaee](https://github.com/craft-ts/craft-ts/commit/8f62caaee))
- **dev-tools:** style nodes in the graph, and the predicates over them ([f1d99ed67](https://github.com/craft-ts/craft-ts/commit/f1d99ed67))
- **dev-tools:** limit craft declarations per file ([2000dc3ea](https://github.com/craft-ts/craft-ts/commit/2000dc3ea))
- **effect:** wave-0 throwaway prototype — yield* Effect in the craft pump ([cfdbaa49b](https://github.com/craft-ts/craft-ts/commit/cfdbaa49b))
- **effect:** wave 2 — the @craft-ts/effect bridge, on Effect v4 ([d26970345](https://github.com/craft-ts/craft-ts/commit/d26970345))
- **effect:** wave 3, and close the 2.6 scope leak ([39a4e7157](https://github.com/craft-ts/craft-ts/commit/39a4e7157))
- **effect:** close finding 0.1-b — Effect errors checked at compile time ([407eb146f](https://github.com/craft-ts/craft-ts/commit/407eb146f))
- **effect:** task 3.3 — fine dependency-graph edges, completing wave 3 ([0b088eb9e](https://github.com/craft-ts/craft-ts/commit/0b088eb9e))
- ⚠️  **effect:** task 1.4 — service scope becomes providedIn ([f5b19d144](https://github.com/craft-ts/craft-ts/commit/f5b19d144))
- ⚠️  **effect:** land wave 1 — _tag discriminant and providedIn scope ([d81618e4e](https://github.com/craft-ts/craft-ts/commit/d81618e4e))
- **effect:** add Effect-aware Craft adapters ([3a0372526](https://github.com/craft-ts/craft-ts/commit/3a0372526))
- **effect:** add Effect quickstart and adapter boundaries ([395b28801](https://github.com/craft-ts/craft-ts/commit/395b28801))
- **effect:** restrict Effect usage to loaders ([f5fe9d051](https://github.com/craft-ts/craft-ts/commit/f5fe9d051))
- **effect:** computedEffect becomes the Effect counterpart of craftComputed ([0aded2d30](https://github.com/craft-ts/craft-ts/commit/0aded2d30))
- **forms:** type submit exception rules ([608753c08](https://github.com/craft-ts/craft-ts/commit/608753c08))
- **forms:** support composed field insertions ([9dff8d8cb](https://github.com/craft-ts/craft-ts/commit/9dff8d8cb))
- **forms:** enforce grouped exception handling ([d807b88ea](https://github.com/craft-ts/craft-ts/commit/d807b88ea))
- **graph:** polish dependency graph visualization ([fa25d06d8](https://github.com/craft-ts/craft-ts/commit/fa25d06d8))
- **mcp:** ship a consumer MCP server, Agent Skills, and llms.txt ([690579d04](https://github.com/craft-ts/craft-ts/commit/690579d04))
- **mcp:** treat architecture tests as the agent graph contract ([e48effa3f](https://github.com/craft-ts/craft-ts/commit/e48effa3f))
- **release:** add local multi-repo release command ([1ba043621](https://github.com/craft-ts/craft-ts/commit/1ba043621))
- **release:** actionable git sync errors with fix commands ([e5892e6f3](https://github.com/craft-ts/craft-ts/commit/e5892e6f3))
- **routes:** implement exhaustive route exception handling and child route mounting checks ([9bb55e54e](https://github.com/craft-ts/craft-ts/commit/9bb55e54e))
- **routes:** make guarded data yieldable ([dddcd437c](https://github.com/craft-ts/craft-ts/commit/dddcd437c))
- **server-functions:** client boundary V2 — client middleware, client context, craftHandshake ([ec044d1a7](https://github.com/craft-ts/craft-ts/commit/ec044d1a7))
- **server-functions:** craftHandshakeMiddleware remplace requireClientDI ([83e1ddd9f](https://github.com/craft-ts/craft-ts/commit/83e1ddd9f))
- **style:** sketch the design system so the API problems surface now ([ae7e5901b](https://github.com/craft-ts/craft-ts/commit/ae7e5901b))
- **style:** turn the sketch into the package — wave 1 of the plan ([bf23cdae3](https://github.com/craft-ts/craft-ts/commit/bf23cdae3))
- **style:** seal level 1 with lint rules and migrate the witness component ([d5a422bd4](https://github.com/craft-ts/craft-ts/commit/d5a422bd4))
- **style:** the axis vocabulary — wave 2, tasks 12 to 14 ([cc1cb6bcd](https://github.com/craft-ts/craft-ts/commit/cc1cb6bcd))
- **style:** the axis budget and the branch sum — wave 2 complete ([fd112467f](https://github.com/craft-ts/craft-ts/commit/fd112467f))
- **style-testing:** the visual matrix — wave 2, tasks 17 to 20 ([92f23fc6d](https://github.com/craft-ts/craft-ts/commit/92f23fc6d))
- **tooling:** add local log server and logs MCP server ([70849b684](https://github.com/craft-ts/craft-ts/commit/70849b684))

### 🩹 Fixes

- using afterRecomputation with readonly source ([ae220a7a3](https://github.com/craft-ts/craft-ts/commit/ae220a7a3))
- improve documentation clarity and correct typos across multiple files ([52859fb64](https://github.com/craft-ts/craft-ts/commit/52859fb64))
- preserve demo template input state ([29efc15e6](https://github.com/craft-ts/craft-ts/commit/29efc15e6))
- stop leaking Angular types from craft public indexes ([1fcc0de6a](https://github.com/craft-ts/craft-ts/commit/1fcc0de6a))
- keep SignalSource yieldable and HostSignal readonly ([4568fc9a3](https://github.com/craft-ts/craft-ts/commit/4568fc9a3))
- keep defer interaction listening on non-element parents ([4009ed18b](https://github.com/craft-ts/craft-ts/commit/4009ed18b))
- preserve HTTP error status and repeated query params ([029955af7](https://github.com/craft-ts/craft-ts/commit/029955af7))
- connect Craft and Angular reactive graphs ([57a6deade](https://github.com/craft-ts/craft-ts/commit/57a6deade))
- preserve Angular signal consumers during Craft swap ([970da1484](https://github.com/craft-ts/craft-ts/commit/970da1484))
- retrace mixed Angular and Craft effect graphs ([b3e81262d](https://github.com/craft-ts/craft-ts/commit/b3e81262d))
- lazy Craft-to-Angular computed invalidation ([032b0a78f](https://github.com/craft-ts/craft-ts/commit/032b0a78f))
- evaluate craftComputed once per invalidation ([754254a37](https://github.com/craft-ts/craft-ts/commit/754254a37))
- recover thrown craftComputed and restore craftWatch options ([b88138a25](https://github.com/craft-ts/craft-ts/commit/b88138a25))
- restore Angular injection context in host injector run ([c34846c4e](https://github.com/craft-ts/craft-ts/commit/c34846c4e))
- keep interpreter queries and derived readers live ([7e3ca19ca](https://github.com/craft-ts/craft-ts/commit/7e3ca19ca))
- destroy linked Craft watches and finish TestBed migration ([d6566282f](https://github.com/craft-ts/craft-ts/commit/d6566282f))
- destroy linked Craft watches on resource and form eviction ([0e922b435](https://github.com/craft-ts/craft-ts/commit/0e922b435))
- destroy parallel form field state on eviction ([1e6d676f8](https://github.com/craft-ts/craft-ts/commit/1e6d676f8))
- bind parallel form item injectors to form DestroyRef ([e0cd77c8b](https://github.com/craft-ts/craft-ts/commit/e0cd77c8b))
- drop the page MCP client card on goodbye, not on every socket close ([8f204b85a](https://github.com/craft-ts/craft-ts/commit/8f204b85a))
- target the single ready page tab even when a reloading card remains ([c5c34c8bc](https://github.com/craft-ts/craft-ts/commit/c5c34c8bc))
- assign a new page clientId instead of evicting an already-open tab ([a432f387e](https://github.com/craft-ts/craft-ts/commit/a432f387e))
- treat a silent page WebSocket as reloading via protocol ping ([e5256f192](https://github.com/craft-ts/craft-ts/commit/e5256f192))
- load lazy route components and keep param signals live ([05d0672d0](https://github.com/craft-ts/craft-ts/commit/05d0672d0))
- wait for hello/ok, goodbye on tab close, and back off page MCP reconnects ([71ce4d274](https://github.com/craft-ts/craft-ts/commit/71ce4d274))
- resolve loadChildren and flush view transitions synchronously ([afed71f53](https://github.com/craft-ts/craft-ts/commit/afed71f53))
- keep page MCP navigate optional and destroy the badge on stop ([29947f596](https://github.com/craft-ts/craft-ts/commit/29947f596))
- stop stay loops and query remounts on Craft matches ([f64463a6c](https://github.com/craft-ts/craft-ts/commit/f64463a6c))
- say page targets one ready tab and wire demo navigate for goto ([5827e9132](https://github.com/craft-ts/craft-ts/commit/5827e9132))
- slice Craft matches per nested outlet depth ([61d43048a](https://github.com/craft-ts/craft-ts/commit/61d43048a))
- reuse parent outlets and honor Craft redirects ([52a4584b2](https://github.com/craft-ts/craft-ts/commit/52a4584b2))
- keep in-flight loadComponent across match reuse ([5c6eba9dd](https://github.com/craft-ts/craft-ts/commit/5c6eba9dd))
- close Craft router seam without Angular Router ([450f979ca](https://github.com/craft-ts/craft-ts/commit/450f979ca))
- isolate view-transition state and skipLocationChange url ([6ecb805c5](https://github.com/craft-ts/craft-ts/commit/6ecb805c5))
- clear view-transition state on skip and recover without Angular Router ([2caa38f7c](https://github.com/craft-ts/craft-ts/commit/2caa38f7c))
- subscribe Craft router trace to CRAFT_ROUTER events ([437265811](https://github.com/craft-ts/craft-ts/commit/437265811))
- move remaining Angular islands and restore TestBed tests ([b10e83e34](https://github.com/craft-ts/craft-ts/commit/b10e83e34))
- close Angular island cut without runtime require ([73df561d6](https://github.com/craft-ts/craft-ts/commit/73df561d6))
- restore DestroyRef on the Angular island ([d98612f99](https://github.com/craft-ts/craft-ts/commit/d98612f99))
- restore lib typecheck, CI coverage, and router contracts ([11b78e6e4](https://github.com/craft-ts/craft-ts/commit/11b78e6e4))
- keep TestBed remainder off CI until ngc is green ([8b5814702](https://github.com/craft-ts/craft-ts/commit/8b5814702))
- import CraftPendingComponentHost from @craft-ng/angular ([7fd880ee9](https://github.com/craft-ts/craft-ts/commit/7fd880ee9))
- treat Angular injection context as in-context for craftEffect ([c0fe42425](https://github.com/craft-ts/craft-ts/commit/c0fe42425))
- survive a destroyed Angular host injector and load templates as text ([7dba18049](https://github.com/craft-ts/craft-ts/commit/7dba18049))
- break the core<->angular build cycle and restore the interpreter suite ([56390ed6b](https://github.com/craft-ts/craft-ts/commit/56390ed6b))
- build both packages without Angular in the output ([c0fd44c7d](https://github.com/craft-ts/craft-ts/commit/c0fd44c7d))
- typecheck the demo cleanly ([820abcab7](https://github.com/craft-ts/craft-ts/commit/820abcab7))
- make a bound <select> show the value it is bound to ([ad110b12c](https://github.com/craft-ts/craft-ts/commit/ad110b12c))
- keep server function demo dependency free ([3e1b1b8b2](https://github.com/craft-ts/craft-ts/commit/3e1b1b8b2))
- support first publication after package rename ([aa8e97827](https://github.com/craft-ts/craft-ts/commit/aa8e97827))
- make demo release sync idempotent ([edcd82bef](https://github.com/craft-ts/craft-ts/commit/edcd82bef))
- push release commits before publishing ([a391b5ee5](https://github.com/craft-ts/craft-ts/commit/a391b5ee5))
- stabilize release validation ([caac4c930](https://github.com/craft-ts/craft-ts/commit/caac4c930))
- resume partial package releases ([72cf096bf](https://github.com/craft-ts/craft-ts/commit/72cf096bf))
- sync standalone demo style dependencies ([7ed98948c](https://github.com/craft-ts/craft-ts/commit/7ed98948c))
- allow demo cache reset reload ([3a32ddab3](https://github.com/craft-ts/craft-ts/commit/3a32ddab3))
- make demo architecture release-safe ([ad8f063fb](https://github.com/craft-ts/craft-ts/commit/ad8f063fb))
- infer generator query params correctly ([5e0643923](https://github.com/craft-ts/craft-ts/commit/5e0643923))
- exclude vendored references from nx graph ([1796136b8](https://github.com/craft-ts/craft-ts/commit/1796136b8))
- **architecture:** index fnUntraced Effect operations ([a547dfd15](https://github.com/craft-ts/craft-ts/commit/a547dfd15))
- **component:** accept literal element nodes ([28c752000](https://github.com/craft-ts/craft-ts/commit/28c752000))
- **component:** serialize htmlFor and boolean aria attributes ([2ddc6c2b8](https://github.com/craft-ts/craft-ts/commit/2ddc6c2b8))
- **component:** serialize boolean false on aria attributes ([594fc4314](https://github.com/craft-ts/craft-ts/commit/594fc4314))
- **component:** treat an explicit empty liveRegion label as provided ([1b6d4c104](https://github.com/craft-ts/craft-ts/commit/1b6d4c104))
- **component:** tighten getByRole errors and accessible names ([450eb2d34](https://github.com/craft-ts/craft-ts/commit/450eb2d34))
- **component:** restore RegExp lastIndex after getByRole name match ([85df08f54](https://github.com/craft-ts/craft-ts/commit/85df08f54))
- **component:** hide closed disclosure panels and clear label htmlFor ([5f04420d9](https://github.com/craft-ts/craft-ts/commit/5f04420d9))
- **component:** keep DOM listeners across patches and inherit parent route props ([51d1ae725](https://github.com/craft-ts/craft-ts/commit/51d1ae725))
- **component:** let a pendingBlock survive a synchronous suspension ([428603f00](https://github.com/craft-ts/craft-ts/commit/428603f00))
- **core:** yield insertion state reads and writes ([83c9a18f1](https://github.com/craft-ts/craft-ts/commit/83c9a18f1))
- **core:** attach runtime meta to abstract inject helpers ([aeb0dc240](https://github.com/craft-ts/craft-ts/commit/aeb0dc240))
- **core:** keep the persister independent of effect timing ([aae62441e](https://github.com/craft-ts/craft-ts/commit/aae62441e))
- **core:** keep sibling dependency maps when a primitive has none ([7f30357c0](https://github.com/craft-ts/craft-ts/commit/7f30357c0))
- **core:** close the type holes the spec type-check uncovered ([7b83102b6](https://github.com/craft-ts/craft-ts/commit/7b83102b6))
- **correlation-id:** stop every binding from depending on the correlation id ([eda8dceb0](https://github.com/craft-ts/craft-ts/commit/eda8dceb0))
- **demo:** use craft query status type ([c79a51d0c](https://github.com/craft-ts/craft-ts/commit/c79a51d0c))
- **demo:** keep app start callback synchronous ([c2939da22](https://github.com/craft-ts/craft-ts/commit/c2939da22))
- **demo:** give the pagination demos the boundary they were missing ([d16e4d9c6](https://github.com/craft-ts/craft-ts/commit/d16e4d9c6))
- **demo:** restore the btn class on the pagination buttons ([b287029b5](https://github.com/craft-ts/craft-ts/commit/b287029b5))
- **demo:** pass direct yieldable callback lint ([b77848001](https://github.com/craft-ts/craft-ts/commit/b77848001))
- **demo:** satisfy Craft lint rules ([10ef7a4e2](https://github.com/craft-ts/craft-ts/commit/10ef7a4e2))
- **demo:** allow local filter state in middleware example ([e0e50b3d6](https://github.com/craft-ts/craft-ts/commit/e0e50b3d6))
- **demo:** allow adapter casts in teaching loaders ([e54666bf8](https://github.com/craft-ts/craft-ts/commit/e54666bf8))
- **docs:** keep reactive snippet bindings granular ([a118c458a](https://github.com/craft-ts/craft-ts/commit/a118c458a))
- **effect:** route httpDeps were silently empty after the scope rename ([b8adf7911](https://github.com/craft-ts/craft-ts/commit/b8adf7911))
- **effect:** six more silently-broken type positions, found by sweeping ([1149e617c](https://github.com/craft-ts/craft-ts/commit/1149e617c))
- **effect:** merge main, and purge the old API the compiler could not see ([b1076de2f](https://github.com/craft-ts/craft-ts/commit/b1076de2f))
- **effect:** align examples and starters with Effect patterns ([106b87f4e](https://github.com/craft-ts/craft-ts/commit/106b87f4e))
- **effect:** type todo mutation failures ([7abcef32d](https://github.com/craft-ts/craft-ts/commit/7abcef32d))
- **mutation:** run the loader once per call, on the right params ([e4f1075ae](https://github.com/craft-ts/craft-ts/commit/e4f1075ae))
- **pagination:** keep the previous rows while the next page loads ([d4b416c53](https://github.com/craft-ts/craft-ts/commit/d4b416c53))
- **pagination:** make `state` agree with the rows on screen ([7e26f84ea](https://github.com/craft-ts/craft-ts/commit/7e26f84ea))
- **release:** install dependencies before local builds ([cd65e34ba](https://github.com/craft-ts/craft-ts/commit/cd65e34ba))
- **release:** publish fixed-group packages from dist ([09d60da52](https://github.com/craft-ts/craft-ts/commit/09d60da52))
- **release:** sync internal dependencies and demo tooling ([812fd0e07](https://github.com/craft-ts/craft-ts/commit/812fd0e07))
- **release:** retry npm registry verification ([8fc95908a](https://github.com/craft-ts/craft-ts/commit/8fc95908a))
- **release:** keep correlation tracking disabled in target ([72c35d82d](https://github.com/craft-ts/craft-ts/commit/72c35d82d))
- **release:** disable target log forwarding ([d34036b55](https://github.com/craft-ts/craft-ts/commit/d34036b55))
- **release:** version @craft-ng/mcp from its package.json ([f56c276a9](https://github.com/craft-ts/craft-ts/commit/f56c276a9))
- **release:** allow package-lock.json in the version bump ([bde68e9fd](https://github.com/craft-ts/craft-ts/commit/bde68e9fd))
- **release:** pack @craft-ng/mcp from an absolute path ([f11297394](https://github.com/craft-ts/craft-ts/commit/f11297394))
- **release:** sync Effect demo i18n dependencies ([03e358965](https://github.com/craft-ts/craft-ts/commit/03e358965))
- **release:** sync internal dependency ranges before versioning ([aa3c932fa](https://github.com/craft-ts/craft-ts/commit/aa3c932fa))
- **release:** update workspace lock entries locally ([2585de2a5](https://github.com/craft-ts/craft-ts/commit/2585de2a5))
- **router:** keep the route component alive across a param change ([6d9933048](https://github.com/craft-ts/craft-ts/commit/6d9933048))
- **signals:** stop alien-signals from overruling craft's own semantics ([5c95e956d](https://github.com/craft-ts/craft-ts/commit/5c95e956d))
- **signals:** let a self-referential read stay undefined, not throw ([d11dbe6a9](https://github.com/craft-ts/craft-ts/commit/d11dbe6a9))
- **style:** give the plugin's imports real specifiers ([f9e0d929e](https://github.com/craft-ts/craft-ts/commit/f9e0d929e))

### 🔥 Performance

- **insert-select:** stop a selected item from depending on the whole collection ([21471f16b](https://github.com/craft-ts/craft-ts/commit/21471f16b))

### ⚠️  Breaking Changes

- **effect:** land wave 1 — _tag discriminant and providedIn scope  ([d81618e4e](https://github.com/craft-ts/craft-ts/commit/d81618e4e))
...
- **effect:** task 1.4 — service scope becomes providedIn  ([f5b19d144](https://github.com/craft-ts/craft-ts/commit/f5b19d144))
- **core:** suppression de track()  ([f8780ce67](https://github.com/craft-ts/craft-ts/commit/f8780ce67))
- **core:** state/query/mutation/asyncProcess/queryParam retournent un générateur  ([847ae73c5](https://github.com/craft-ts/craft-ts/commit/847ae73c5))
