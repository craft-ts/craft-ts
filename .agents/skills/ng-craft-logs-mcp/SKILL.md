...
1. `npm test --workspace @ng-craft/log-server` for ingestion, batch parsing, JSONL storage, and rotation.
2. `npm test --workspace @ng-craft/log-mcp` for the reader filters and the MCP tool surface.
