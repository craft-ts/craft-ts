...
const sourcePath = resolve(
  workspaceRoot,
  'apps/demo/src/app/app.routes.source.ts',
);
const generatedPath = resolve(workspaceRoot, 'apps/demo/src/app/app.routes.ts');
...
function generateRoutes(source, enabledRouteIds) {
  ...
  return `// This file is generated by tools/serve-demo.mjs. Edit app.routes.source.ts instead.\n${lintDirective}${generated.trimEnd()}\n`;
}
...
async function main() {
  ...
  writeFileSync(generatedPath, generateRoutes(source, enabledRouteIds));
