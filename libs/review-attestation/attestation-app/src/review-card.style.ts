...
export const templateReviewGroup = craftStyles('templateReviewGroup', {
  ...
  selection: [display.flex, flexWrap.wrap, alignItems.center, gap(unit.px(8))],
  list: [
    display.grid,
    gap(unit.px(8)),
  ...
  /** One selectable obligation and its explanation. */
  obligation: [
    display.flex,
    alignItems.start,
    gap(unit.px(10)),
  ...
  obligationCheckbox: [marginBlockStart(unit.px(4))],
  obligationCopy: [
    display.grid,
    flex(num(1)),
    gap(unit.px(6)),
  ...
  agentResult: [display.grid, gap(unit.px(4))],
  obligationDetails: [
    display.grid,
    gap(unit.px(4)),
