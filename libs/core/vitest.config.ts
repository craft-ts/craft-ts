...
export default defineConfig({
  ...
  test: {
    ...
    exclude: [
      ...
      'src/lib/form/craft-field.directive.spec.ts',
      ...
      'src/lib/form/parallel-form-dom-bindings.spec.ts',
      'src/lib/form/validator-dom-bindings.spec.ts',
      ...
      'src/lib/host/angular-island-destroy-ref.spec.ts',
      'src/lib/host/from-angular-signal.spec.ts',
