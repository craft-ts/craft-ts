export const craftDemoRules = {
  ...
  'craft-ts/no-angular-inject': 'error',
  'craft-ts/no-angular-signal-forms': 'error',
  ...
  'craft-ts/prefer-craft-computed': 'error',
  'craft-ts/no-craft-computed-side-effects': 'error',
  'craft-ts/prefer-craft-reactivity': 'warn',
  'craft-ts/provide-host-name-match-component': 'warn',
  'craft-ts/prefer-craft-http-client': 'error',
  'craft-ts/prefer-craft-http-transport': 'error',
  'craft-ts/prefer-craft-input-output': 'error',
  'craft-ts/prefer-craft-state': 'error',
  'craft-ts/prefer-craft-effect': 'error',
  'craft-ts/no-imperative-craft-resource-trigger': 'error',
  'craft-ts/require-craft-resource-trigger-yield': 'error',
  'craft-ts/prefer-craft-service': 'warn',
  ...
  'craft-ts/prefer-craft-router-outlet': 'warn',
