...
| `ComponentTemplateOf`, `TemplateChildren`, `SetupTestComponentTemplate`                                                                                                                                                                                                                                                                                                                                                                                                                                   | Resolves a component's nodes and validates its template at compile time | [Type-level tests](/guide/testing/type-level)           |
